Feature: Having a working reservation-surveys endpoint
  ...
  Scenario: Successfully creating a simple reservation survey
    ...
    """
    Then I expect RabbitMq to produce a message
    And I should get 201 response with JSON body:
    """
    {
        "id_survey": 4,
        "id_customer": 12,
  ...
  Scenario: Failing to create a survey with invalid parameters
    ...
    """
    Then I expect RabbitMq to stay calm
    And I should get 422 response with JSON body:
    """
    [
  ...
  Scenario: Failing to create a survey with already existing id_customer/id_reservation pair
    ...
    """
    Then I expect RabbitMq to stay calm
    And I should get 409 response with JSON body:
    """
    {
  ...
  Scenario: Successfully updating a survey
    ...
    """
    Then I expect RabbitMq to produce a message
    And I should get 200 response with JSON body:
    """
    {
        "id_survey": 1,
        "id_customer": 456,
